...
export default function Depan() {
    return (
        <>
            <section className="bg-primary-300 dark:bg-gray-900 -5">
            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    <div className="max-w-screen-lg mb-8 lg:mb-16">
                        ...
                        <p className="text-gray-500 sm:text-xl dark:text-gray-400">Kami berkomitmen untuk memberikan pengalaman terbaik dalam PPDB SMP N 48 Rosevelt. Teknologi yang inovatif, integrasi yang sempurna, dan kemudahan akses untuk meningkatkan proses penerimaan siswa.</p>
                    </div>
                    <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                        <div>
                            <div className="flex justify-center items-center mb-4 dark:text-white w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                                <FaAddressCard />
                            </div>
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Pendaftaran Online</h3>
                            <p className="text-gray-500 dark:text-gray-400">Daftar secara online dengan mudah. Pelajari informasi lengkap, unggah dokumen, dan ikuti langkah-langkah pendaftaran langsung melalui platform kami.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 dark:text-white w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                                <FaListCheck />
                            ...
                            <p className="text-gray-500 dark:text-gray-400">Lengkapi proses verifikasi dokumen secara online. Kami menyediakan alur kerja yang aman dan efisien untuk memvalidasi dokumen-dokumen penting.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 dark:text-white w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                                <FaBullhorn />
                            ...
                            <p className="text-gray-500 dark:text-gray-400">Lihat hasil seleksi dengan cepat dan mudah. Informasi terkait diterima atau tidaknya peserta didik baru akan tersedia secara langsung di platform kami.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 dark:text-white w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                                <FaCalendarDays />
                            ...
                            <p className="text-gray-500 dark:text-gray-400">Akses jadwal lengkap untuk tahapan PPDB SMP. Jadwal tes, pengumuman, dan tahapan lainnya tersedia secara transparan untuk memudahkan para calon siswa.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 dark:text-white w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                                <FaTeamspeak />
                            ...
                            <p className="text-gray-500 dark:text-gray-400">Dapatkan bantuan langsung melalui layanan dukungan online. Tim kami siap membantu dan menjawab pertanyaan seputar proses PPDB dengan cepat.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 dark:text-white w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                                <FaCircleInfo/>
                            ...
                            <p className="text-gray-500 dark:text-gray-400">Dapatkan informasi lengkap mengenai sekolah, kurikulum, fasilitas, dan kegiatan ekstrakurikuler. Temukan segala yang perlu diketahui tentang lingkungan pendidikan kami.</p>
                        </div>
