            ...
            <section className="bg-white rounded-2xl dark:bg-blue-500 m-5">
                <div className="lg:grid flex text-center flex-col-reverse max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div className="mr-auto mt-5 place-self-center lg:col-span-7">
                        ...
                        <Link to={'/login'} className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-300  hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-300 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Masuk
                        </Link>
                    </div>
