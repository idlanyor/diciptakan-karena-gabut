                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className={`items-center justify-between md:flex w-full md:w-auto md:order-1 ${isMobileNav ? 'block' : 'hidden'}`} id="navbar-sticky">
                        <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100  bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            ...
                            <li>
                                <Link to="/jadwal-pendaftaran" className={`block py-2 px-3 text-gray-900  hover:bg-gray-100 md:hover:bg-transparent md:hover:text-purple-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-blue-700 dark:hover:text-white md:dark:hover:bg-transparent dark:bg-blue-500 dark:border-gray-700 ${window.location.pathname == '/jadwal-pendaftaran' ? 'md:bg-transparent  md:dark:bg-transparent bg-slate-200 text-purple-500 md:dark:text-blue-500' : 'dark:bg-transparent md:dark:text-white'}`}>Jadwal Pendaftaran</Link>
                            </li>
                            <li>
                                <Link to="/rincian-biaya" className={`block py-2 px-3 text-gray-900  hover:bg-gray-100 md:hover:bg-transparent md:hover:text-purple-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-blue-700 dark:hover:text-white md:dark:hover:bg-transparent dark:bg-blue-500 dark:border-gray-700 ${window.location.pathname == '/rincian-biaya' ? 'md:bg-transparent md:dark:bg-transparent bg-slate-200 text-purple-500 md:dark:text-blue-500' : 'dark:bg-transparent md:dark:text-white'}`}>Rincian Biaya</Link>
                            </li>
                            <li>
                                <Link to="/pengumuman" className={`block py-2 px-3 text-gray-900  hover:bg-gray-100 md:hover:bg-transparent md:hover:text-purple-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-blue-700 dark:hover:text-white md:dark:hover:bg-transparent dark:bg-blue-500 dark:border-gray-700 ${window.location.pathname == '/pengumuman' ? 'md:bg-transparent md:dark:bg-transparent bg-slate-200 text-purple-500 md:dark:text-blue-500' : 'dark:bg-transparent md:dark:text-white'}`}>Informasi</Link>
                            </li>
                        </ul>
                    </div>
                </div>
