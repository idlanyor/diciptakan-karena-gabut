        ...
        <>
                ...
                <div className="py-2 px-4 mx-auto lg:py-4">
                    ...
                    <dl className="max-w-md text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                        <div className="flex flex-col pb-3">
                            <dt className="mb-1 text-gray-500 md:text-lg dark:text-white">Gelombang saat ini</dt>
                            <dd className="text-lg font-semibold">Gelombang 1</dd>
                        </div>
                        <div className="flex flex-col py-3">
                            <dt className="mb-1 text-gray-500 md:text-lg dark:text-white">Periode</dt>
                            <dd className="text-lg font-semibold">12 Desember 2023 - 23 Januari 2024</dd>
                        </div>
                        <div className="flex flex-col pt-3">
                            <dt className="mb-1 text-gray-500 md:text-lg dark:text-white">Jumlah terdaftar/Total Kuota</dt>
            ...
            <div className="block mt-5 p-6 bg-white border border-gray-200  shadow  dark:bg-gray-800 dark:border-gray-700 ">
                <div className="py-2 px-4 mx-auto lg:py-4">
                    ...
                    <div className="flex">
                        <span className="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border rounded-e-0 border-gray-300 rounded-s-md dark:bg-gray-600 dark:text-white dark:border-gray-600">
