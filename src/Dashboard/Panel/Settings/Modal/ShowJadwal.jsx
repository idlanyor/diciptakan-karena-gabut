...
const ShowJadwal = ({ isClicked }) => {
    return (
        <>
            {
                isClicked && (
                    <div id="showJadwal" tabIndex="-1" aria-hidden="true" className={`${isClicked ? 'block':'hidden'} overflow-y-auto overflow-x-hidden fixed top-0 right-50 left-5 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full`}>
